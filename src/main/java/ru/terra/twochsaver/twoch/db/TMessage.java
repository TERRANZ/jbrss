 ...
 */
package ru.terra.twochsaver.twoch.db;
...
public class TMessage implements Serializable {
	...
	public TMessage(Long num, long lasthit, String msgdate, long msgsize, long msgtimestamp, long closed, long parent, String subject, String name,
			String comment, long op) {
		this.num = num;
	...
	public String toString() {
		return "main.java.ru.terra.twochsaver.twoch.db.TMessage[ num=" + num + " ]";
	}
