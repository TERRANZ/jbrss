...
@NamedNativeQueries({
        ...
        @NamedNativeQuery(name = "Feedposts.findFeedpostsByFeedLimited", query = "SELECT f.* FROM Feedposts f WHERE f.feed_id = ?1 ORDER BY f.postdate DESC OFFSET ?2 LIMIT ?3")})
@NamedQueries({
